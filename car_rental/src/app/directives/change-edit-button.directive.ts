  ...
  changeLook():void{
    ...
    if(this.edit_shown){
      if(ChangeEditButtonDirective.previousElement!=null){
        ...
        ChangeEditButtonDirective.previousElement.nativeElement.style = "background:linear-gradient(90deg, rgb(1, 106, 1), transparent) rgb(34, 213, 17)";
      }
      this.element.nativeElement.textContent="Ukryj";
      ChangeEditButtonDirective.previousElement = this.element;
      this.element.nativeElement.style="background:linear-gradient(90deg, rgb(1, 32, 117), transparent) rgb(17, 115, 213)";
      // change color
    }
    else{
      this.element.nativeElement.textContent="Modyfikuj";
      this.element.nativeElement.style = "background:linear-gradient(90deg, rgb(1, 106, 1), transparent) rgb(34, 213, 17)";
      // change color
    }
  }
